...
export interface Topic {
  name: string; definition: string; method?: string; trap?: string; exercise?: string; formula?: string; deep: DeepTopic;
}
export interface Level {
  n: number; title: string; domain: string; obj: string; topics: Topic[];
  academy?: {letter?: string}; prereq?: number[]; exam?: string; source_refs: string[]; [key:string]: unknown;
}
export interface LevelSummary {
  n:number; title:string; domain:string; obj:string; topicCount:number;
  academy?: {letter?: string}; prereq?: number[]; exam?: string; source_refs?: string[];
}
export interface Manifest { meta: Record<string, unknown> & {as_of:string; levels:number; topics:number}; levels:LevelSummary[]; academies:any[] }
export interface CaseItem { title?:string; t?:string; data?:string; d?:string; questions?:string[]; q?:string[]; answer?:string; a?:string }
